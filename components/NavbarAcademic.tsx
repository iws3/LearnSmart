...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Seeds', icon: Plus, href: '/companions/new', gradient: 'from-orange-500 to-red-400' },
    { name: 'Garden', icon: Brain, href: '/companions', gradient: 'from-blue-500 to-cyan-400' },
    { name: 'Events', icon: DollarSign, href: '/billing', gradient: 'from-green-500 to-emerald-400' },
  ...
  const mobileTabItems = [
    ...
    { name: 'seeds', icon: BookOpen, id: 'learn', href: '/companions', color: 'text-purple-400' },
    { name: 'Garden', icon: Trophy, id: 'progress', href: '/journey', color: 'text-orange-400' },
